...
public abstract class BaseObject {
	...
	protected static Logger log = Logger.getLogger(BaseObject.class.getName());
	...
	protected Map<String,Object> updateById(String methodName) throws XmlRpcException{
		...
		else throw new XmlRpcException("There are no locally updated fields to update via xmlrpc!");
